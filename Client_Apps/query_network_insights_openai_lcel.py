...
def main():
    """
    OpenAI RAG query app using LCEL (Runnable pipeline) for easier composition.
    """
    ...
    prompt = ChatPromptTemplate.from_messages([("system", genaiops_prompt), ("human", "{input}")])
    ...
    while True:
        ...
        response = answer_chain.invoke({
            "context": format_docs(matching_docs),
